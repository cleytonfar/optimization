...
main(){
	...
	print("\nHESSIAN: ", "             ", "Analytical");
	print("\nSAMPLE SIZE: ", "%12d", N);
	print("\nLog likelihood: ", "% 12.3f", double(dVal_log_SD));
	print("\n\nTRUE PARAMETERS: ", "%r", {"BETA0", "BETA1"}, "%21.3f", Beta0|Beta1);
	print("\nML Estimators: ", "%r", {"beta0^", "beta1^"}, "%14.3f",vPar_log_SD);
	print("\n\n");
	...
	print("\nHessian: ", "             ", "Analytical");
	print("\nSAMPLE SIZE: ", "%12d", N);
	print("\nLog likelihood: ", "% 12.3f", double(dVal_log_Newton));
	print("\n\nTRUE PARAMETERS: ", "%r", {"BETA0", "BETA1"}, "%21.3f", Beta0|Beta1);
	print("\nML Estimators: ", "%r", {"beta0^", "beta1^"}, "%14.3f",vPar_log_Newton);
	print("\n\n");
	...
	print("\nGRADIENT: ", "            ", "Analytical");
	print("\nSAMPLE SIZE: ", "%12d", N);
	print("\nLog likelihood: ", "% 12.3f", double(dVal_log_BFGS));
	print("\n\nTRUE PARAMETERS: ", "%r", {"BETA0", "BETA1"}, "%21.3f", Beta0|Beta1);
	print("\nML Estimators: ", "%r", {"beta0^", "beta1^"}, "%14.3f",vPar_log_BFGS);
	print("\n\n");
